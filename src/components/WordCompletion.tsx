...
const WordCompletion: React.FC<WordCompletionProps> = ({ word, hint, audioUrl, onComplete }) => {
  ...
  const playAudio = () => {
    if (audioUrl) {
      ...
      message.warning('该单词暂无音频。');
    }
  };

  return (
    <div style={{ maxWidth: 400, margin: 'auto', textAlign: 'center' }}>
      <Title level={3}>单词补全挑战</Title>
      <Text>提示：{hint}</Text>
